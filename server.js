...
function audireConfigLimpa(c){const b=c&&typeof c==='object'?c:{};return {paises_habilitados:Array.isArray(b.paises_habilitados)?[...new Set(b.paises_habilitados.map(x=>String(x||'').trim().toUpperCase()).filter(Boolean))]:null};}
